...
- [ ] Explain benefit(s) using `client-side routing`?
      When routing between views it is faster due to less data being processed because of client side routing. Smooth animation transitions are also easier to implement
